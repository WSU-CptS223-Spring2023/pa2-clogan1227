...
main.o: main.cpp destination.cpp destination.hpp ListMyJosephus.cpp ListMyJosephus.hpp VectorMyJosephus.cpp VectorMyJosephus.hpp TestListMyJosephus.cpp TestVectorMyJosephus.cpp
